...
const Header = () => {
    ...
    return (
        <div className='w-full'>
            <motion.div className={`border-b border-[var(--header-border)] w-full bg-[var(--bg-header)]  select-none z-[8000] h-[60px] px-4 fixed flex items-center justify-between`}
            ...
            >
                ...
                <div className='flex justify-center items-center gap-2'>
                    <PiWaveformFill className='text-4xl text-[var(--primary)]' />
                    <span className='text-2xl text-[var(--primary)]'>Meet Assist</span>
                </div>
